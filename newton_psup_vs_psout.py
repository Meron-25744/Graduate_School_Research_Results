...
Po = [0 for i in range(ps_num)]  # 最大出力電力(給電電力)
...
plt.title('Supply Power vs Maximum output power') 
plt.xlabel('Supply Power [W]')
plt.ylabel('Maximum output power [W]')   
plt.plot(Ps,Po)
plt.grid(True)
plt.show()
